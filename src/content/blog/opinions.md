...
description: >-
  ...
  where I don't learn something useful and even the React ones are fun to listen
  to.
pubDate: 2025-07-25
...
- [Volodymyr Zelenskyy](https://en.wikipedia.org/wiki/Volodymyr_Zelenskyy) was providing the voice for Paddington in movies rather than leading The Ukraine's resistance to Russian agression.
...
Shout out to Wes, Scott and CJ for the excellent work they do on Syntaxfm. I am sure there are other podcasts and blogs out there that look to do the same sort of things as Wes, Scott and CJ but I've yet to find one that does it as well as they do.
