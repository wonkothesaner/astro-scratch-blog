...
heroImageAlt: "My son's hands eagerly typing on computer keyboards in local shop."
---
...
<MediaObject image={AstroThemes} alt="Astro blog themes gallery showcase" source="https://astro.build/themes/" flip="true" imageWidth="200px">
